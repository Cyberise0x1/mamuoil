...
export default function Home() {
  ...
  return (
    <div className="mamu-executive-site">
      ...
      <main>
        <section id="overview" className="executive-hero" aria-labelledby="hero-title">
          ...
          <div className="hero-content">
            <p className="eyebrow"><span /> Zaria, Kaduna <b>/</b> Nigeria</p>
            <h1 id="hero-title">Energy that<br /><em>moves business.</em></h1>
            <p className="hero-lead">Mamu Oil brings a direct, locally rooted route to fuel, kerosene, and oil-and-gas supply conversations from Zaria, Kaduna.</p>
        ...
        <section className="signal-section" aria-label="Mamu Oil operating principles">
          <p className="section-index">Mamu Oil / Zaria route / 01</p>
          <h2>A direct route from <em>enquiry to movement.</em></h2>
          <p className="signal-copy">Mamu Oil connects straightforward commercial access with a clear local presence, visible product focus, and a responsive way to begin a business conversation.</p>
          <div className="signal-points">
            <article><span>01</span><h3>Rooted locally</h3><p>Zaria, Kaduna provides the operating context for every direct enquiry.</p></article>
            <article><span>02</span><h3>Built for clarity</h3><p>Product, enquiry, and contact paths are made easy to understand and reach.</p></article>
            <article><span>03</span><h3>Ready to respond</h3><p>WhatsApp-based access keeps business conversations direct and immediate.</p></article>
          </div>
        </section>

        <section id="capabilities" className="capabilities-section" aria-labelledby="capability-title">
          <div className="section-heading">
            <p className="section-index">Capabilities / 02</p>
            <h2 id="capability-title">A sharper view of<br /><em>what moves through Mamu.</em></h2>
            <p>Explore a capability for clear product and enquiry detail, then move directly to the right commercial channel.</p>
          </div>
        ...
        <section id="operations" className="operations-section" aria-labelledby="operations-title">
          <div className="operations-image-wrap"><img src="/manus-storage/mamu-amber-horizon-operations_a080f0a3.jpg" alt="Fuel terminal and tanker vehicles" /></div>
          <div className="operations-panel">
            <p className="section-index">Operations / 03</p>
            <h2 id="operations-title">Built for the<br /><em>business of movement.</em></h2>
            <p>From a Zaria-rooted operating position, Mamu Oil provides a clear channel for fuel, kerosene, and oil-and-gas enquiries—grounded in local context and handled with direct communication.</p>
            <dl><div><dt>Fuel</dt><dd>Direct supply focus</dd></div><div><dt>Zaria</dt><dd>Kaduna, Nigeria</dd></div></dl>
            <a className="button button--amber" href="#contact">Open a supply enquiry <ArrowRight size={16} /></a>
          </div>
        </section>

        <section className="liquid-banner" aria-label="Mamu Oil in motion">
          <img src="/manus-storage/mamu-amber-horizon-liquid_df62aa51.jpg" alt="Abstract amber liquid ripple" />
          <div><p>Oil movement / 04</p><h2>Measured response.<br /><em>Clear direction.</em></h2><span>A supply current shaped by local route, product focus, and direct response.</span></div>
        </section>

        <section id="contact" className="executive-contact" aria-labelledby="contact-title">
          <div className="contact-intro"><p className="section-index">Contact / Mamu Oil</p><h2 id="contact-title">Start with<br /><em>the right channel.</em></h2><p>Share your requirement and Mamu Oil will receive a prepared message directly on WhatsApp.</p><a href="https://wa.me/2348100737315?text=Hello%20Mamu%20Oil%2C%20I%20would%20like%20to%20make%20an%20enquiry." target="_blank" rel="noreferrer" className="whatsapp-link"><MessageCircle size={18} /> WhatsApp direct <ArrowUpRight size={15} /></a><span className="location-line"><MapPin size={15} /> Zaria, Kaduna, Nigeria</span></div>
          <form className="executive-form" onSubmit={submitEnquiry}>
